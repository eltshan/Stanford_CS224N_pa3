...
public interface Feature {
	...
	public static abstract class IntIndicator implements Feature {
		...
		public boolean equals(Object o) {
			return o instanceof IntIndicator && o.getClass().equals(this.getClass())
					&& ((IntIndicator) o).value == value;
		}
		...
		public BucketIndicator(int value, int max, int numBuckets) {
			...
			if (bucket < 0 || bucket >= numBuckets) {
				throw new IllegalStateException(
						"Bucket out of range: " + value + " max=" + max + " numbuckets=" + numBuckets);
			}
		}

		public boolean equals(Object o) {
			return o instanceof BucketIndicator && o.getClass().equals(this.getClass())
					&& ((BucketIndicator) o).bucket == bucket;
		}
	...
	public static abstract class StringIndicator implements Feature {
		...
		public boolean equals(Object o) {
			return o instanceof StringIndicator && o.getClass().equals(this.getClass())
					&& ((StringIndicator) o).str.equals(this.str);
		}
	...
	public static abstract class SetIndicator implements Feature {
		...
		public boolean equals(Object o) {
			return o instanceof SetIndicator && o.getClass().equals(this.getClass())
					&& ((SetIndicator) o).set.equals(this.set);
		}
	...
	public static class HeadWordMatch extends Indicator {
		public HeadWordMatch(boolean headWordMatch) {
			super(headWordMatch);
		}
	}
